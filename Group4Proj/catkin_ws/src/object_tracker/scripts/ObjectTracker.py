        ...
        if count%10==0:
            ...
            for c in cntc:
                ...
                if len(approx) == 3 and area > 10000:
                    ...
                    tracker.coneW = wc
                    tracker.coneH = hc
                    tracker.coneDist = 15/math.sqrt(hc)
                    tracker.cone = 1
                ...
                if len(approx) == 4 and area > 10000:
                    ...
                    tracker.bucketW = wc
                    tracker.bucketH = hc
                    tracker.bucketDist = 45/math.sqrt(hc)
                    tracker.bucket = 1
            ...
            for c in cntb:
                ...
                if len(approx) == 3 and area > 5000:
                    ...
                    tracker.coneW = wb
                    tracker.coneH = hb
                    tracker.coneDist = 15/math.sqrt(hb)
                    tracker.cone = 1
                ...
                if len(approx) == 4 and area > 5000:
                    ...
                    tracker.bucketW = wb
                    tracker.bucketH = hb
                    tracker.bucketDist = 45/math.sqrt(hb)
                    tracker.bucket = 1
            ...
            for c in cnto:
                ...
                if len(approx) == 4 and area > 10000:
                    ...
                    cv2.putText(cv_image, text= "obstacle", org=(xo+20,yo+30),
                    fontFace= cv2.FONT_HERSHEY_DUPLEX, fontScale=2, color=(0,0,0),
                    thickness=2, lineType=cv2.LINE_AA)
                    tracker.obstacleX = xo
                    tracker.obstacleY = 2000-yo
                    tracker.obstacleW = wo
                    tracker.obstacleH = ho
                    tracker.obstacleDist = 15/math.sqrt(ho)
                    tracker.obstacle = 1
                    
                    cv2.putText(cv_image, text= '{:.2f}m'.format(tracker.obstacleDist), org=(xo+20,yo+70),
                    fontFace= cv2.FONT_HERSHEY_DUPLEX, fontScale=2, color=(0,0,0),
                    thickness=2, lineType=cv2.LINE_AA)
